<template>
  <div style="overflow-x: hidden; margin-top: 15px">
    <div class="md-layout md-gutter md-alignment-center-center">
      <h1 style="text-align:center">{{ $route.params.name }}</h1>
      ...
      <md-list class="md-double-line" style="width: 275px; background-color:rgb(250, 250, 250)">
        <md-list-item style="padding: 2px; margin: 3px; height: 75px" v-for="d in dump_cases" v-bind:key="d.case_id" @click="dialog_func(d)">
          ...
          <div class="md-list-item-text">
            ...
            <span style="color: #91bafb">{{ d.case_date.substring(0, 10) }} {{ d.case_date.substring(11, 16) }}</span>
          </div>
        </md-list-item>
      </md-list>
    </div>
